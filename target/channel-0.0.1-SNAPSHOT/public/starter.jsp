...
<body class="hold-transition skin-black fixed">
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<!-- Logo -->
			<a href="send_monitor_monitor.action" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-lg"><img alt="Access" src="<%=realpath%>/image/accesslogo.png" height="45" width="45"><b>畅联</b>Service</span>
			</a>
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li><a href="send_monitor_monitor.action"> <i
					...
					<li><a href="#"> <i class="fa fa-calendar-o"></i> <span>历史会话查看</span>
					</a></li>
					<li class="treeview"><a href="#"> <i class="fa fa-group"></i>
						...
						<ul class="treeview-menu">
							<li><a href=""><i class="fa fa-circle-o"></i> 所有人管理</a></li>
					...
					<li class="treeview"><a href="#"> <i class="fa fa-tv"></i>
						...
						<ul class="treeview-menu">
							<li><a href="send_service_manager.action"><i
									class="fa fa-circle-o"></i> 客服管理</a></li>
							<li><a href=""><i class="fa fa-circle-o"></i> 客服会话记录查看</a></li>
						</ul></li>
					<li class="treeview"><a href="#"> <i class="fa fa-cubes"></i>
						...
						<ul class="treeview-menu">
							<li><a href=""><i class="fa fa-circle-o"></i> 搜索引擎分析</a></li>
							<li><a href=""><i class="fa fa-circle-o"></i> 访问地区分析</a></li>
							<li><a href=""><i class="fa fa-circle-o"></i> 流量分析</a></li>
							<li><a href=""><i class="fa fa-circle-o"></i> 客户价值分析</a></li>
							<li><a href=""><i class="fa fa-circle-o"></i> 客服热词分析</a></li>
						</ul></li>
					<li class="treeview"><a href="#"> <i class="fa fa-male"></i>
						...
						<ul class="treeview-menu">
							...
							<li><a href=""><i class="fa fa-circle-o"></i> 客户RFM记录</a></li>
							<li><a href=""><i class="fa fa-circle-o"></i> 客户优先级管理</a></li>
						</ul></li>
					<li class="treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li><a href=""><i class="fa fa-circle-o"></i> 机器人知识库管理</a></li>
							<li><a href=""><i class="fa fa-circle-o"></i> 内部知识库管理</a></li>
						</ul></li>
					<li class="treeview"><a href="#"> <i class="fa  fa-gear"></i>
						...
						<ul class="treeview-menu">
							...
							<li><a href=""><i class="fa fa-circle-o"></i> 会话设置</a></li>
