...
<body class="hold-transition skin-black fixed">
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<!-- Logo -->
			<a href="send_administrator_monitor_monitor.action" class="logo">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li><a href="send_administrator_monitor_monitor.action"> <i
							class="fa fa-dashboard"></i> <span>信息预览</span>
					</a></li>
					<li class="treeview"><a href="#"> <i class="fa fa-clone"></i>
							<span>企业管理</span> <span class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							<li><a href="send_administrator_enterprise_manager.action"><i
									class="fa fa-circle-o"></i> 企业管理</a></li>
							<li><a
								href="send_administrator_enterprise_rightmanager.action"><i
									class="fa fa-circle-o"></i> 企业权限管理</a></li>
							<li><a
								href="send_administrator_enterprise_rolemanager.action"><i
									class="fa fa-circle-o"></i> 企业权限分配</a></li>
						</ul></li>
					<li class="treeview"><a href="#"> <i
							class="fa fa-calendar-o"></i> <span>管理员管理</span> <span
						...
						<ul class="treeview-menu">
							<li><a
								href="send_administrator_administrator_usermanager.action"><i
									class="fa fa-circle-o"></i> 管理员管理</a></li>
							<li><a
								href="send_administrator_administrator_rightmanager.action"><i
									class="fa fa-circle-o"></i> 管理员权限管理</a></li>
							<li><a
								href="send_administrator_administrator_rolemanager.action"><i
									class="fa fa-circle-o"></i> 管理员权限分配</a></li>
						</ul></li>
					<li class="treeview"><a href="#"> <i class="fa fa-cubes"></i>
						...
						<ul class="treeview-menu">
							<li><a href=""><i class="fa fa-circle-o"></i>企业日志查看</a></li>
							<li><a href=""><i class="fa fa-circle-o"></i>管理员日志查看</a></li>
						</ul></li>
					<li class="treeview"><a href="#"> <i class="fa  fa-gear"></i>
						...
						<ul class="treeview-menu">
							<li><a href="send_administrator_set_systemset.action"><i
