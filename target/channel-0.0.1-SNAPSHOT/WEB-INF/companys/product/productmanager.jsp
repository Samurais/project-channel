	...
	<div class="modal fade bs-example-modal-lg text-center" id="imgModal"
		...
		<div class="modal-dialog modal-lg"
			...
			<div class="modal-content">
				<img id="imgInModalID" src="" height="500" width="500">
			</div>
		</div>
	</div>
	<!-- ==================================表格和按钮部分================================ -->
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form id="defaultForm" method="post" class="form-horizontal"
						...
						<div class="form-group">
							<label class="col-lg-3 control-label">产品数量</label>
							<div class="col-lg-5">
		...
		$.ajaxFileUpload({
			...
			success : function(data, status) {
				...
				$.post('product_save.action', {
					...
					xremark : div.find("textarea[name=xremark]:first").val(),
		...
		oInit.Init = function() {
			...
			$("#btn_delete").click(function() {
				...
				Ewin.confirm({
					...
					$.ajax({
						type : "post",
						url : "product_deleteByIds.action",
						data : {
							"ids" : ids
						},
						success : function(data, status) {
