			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							...
							<li><a href="send_companys_product_order.action"><i
									class="fa fa-circle-o"></i> 订单查看</a></li>
						</ul></li>
					<li class="treeview"><a href="#"> <i class="fa fa-tv"></i>
						...
						<ul class="treeview-menu">
							...
							<li><a href="send_companys_service_msgmanager.action"><i
									class="fa fa-circle-o"></i> 客服消息记录查看</a></li>
					...
					<li class="treeview"><a href="#"> <i class="fa fa-group"></i>
						...
						<ul class="treeview-menu">
							<li><a href="send_companys_group_groupmanager.action"><i
									class="fa fa-circle-o"></i> 分组管理</a></li>
							<li><a href="send_companys_group_servicegroup.action"><i
					...
					<li class="treeview"><a href="#"> <i class="fa fa-cubes"></i>
						...
						<ul class="treeview-menu">
							...
							<li><a href="send_companys_chart_hotword.action"><i
									class="fa fa-circle-o"></i> 客户热词分析</a></li>
						</ul></li>
					<li class="treeview"><a href="#"> <i
					...
					<li class="treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li><a href="send_companys_servicechart_servicerate.action"><i
									class="fa fa-circle-o"></i> 客服服务率报表</a></li>
							<li><a href="send_companys_servicechart_degree.action"><i
									class="fa fa-circle-o"></i> 客服满意度报表</a></li>
							<li><a href="send_companys_servicechart_achievement.action"><i
									class="fa fa-circle-o"></i> 业绩报表</a></li>
						</ul></li>
