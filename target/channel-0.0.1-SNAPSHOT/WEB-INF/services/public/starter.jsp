...
<body class="hold-transition skin-black fixed">
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<!-- Logo -->
			<a href="send_services_monitor_monitor.action" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li><a href="send_services_monitor_monitor.action"> <i
							class="fa fa-dashboard"></i> <span>智能监控</span>
					</a></li>
					<li><a href="send_services_chat_currentchat.action"> <i
							class="fa fa-calendar-o"></i> <span>当前会话</span>
					</a></li>
					<li><a href="send_services_leavingmsg_leavingmsg.action">
							<i class="fa fa-sticky-note"></i> <span>留言查看</span>
					</a></li>
					<li><a href="send_services_quickmessage_quickmsgmanager.action">
							<i class="fa fa-hand-pointer-o"></i> <span>快捷短语</span>
					</a></li>
					<li><a
						href="send_services_conversation_conversationmanager.action">
							<i class="fa fa-pie-chart"></i> <span>历史会话</span>
					</a></li>
					...
					<li class="treeview"><a href="#"> <i class="fa fa-clone"></i>
						...
						<ul class="treeview-menu">
							<li><a href="send_services_order_orderfinish.action"><i
									class="fa fa-circle-o"></i> 已完成订单</a></li>
							<li><a href="send_services_order_ordernotfinish.action"><i
									class="fa fa-circle-o"></i> 未完成订单</a></li>
						</ul></li>
					<li class="treeview"><a href="#"> <i class="fa fa-cubes"></i>
						...
						<ul class="treeview-menu">
							<li><a
								href="send_services_knowbase_insideknowledgebase.action"><i
									class="fa fa-circle-o"></i> 系统知识库</a></li>
						</ul></li>
