...
public class WebConnectServiceImpl implements WebConnectService {
	...
	// ==========================注入上层对象============================================
	@Resource
	private WebConnectServiceSolve webConnectServiceSolve;

	public void setWebConnectServiceSolve(WebConnectServiceSolve webConnectServiceSolve) {
		this.webConnectServiceSolve = webConnectServiceSolve;
	}
	...
	public void msgFilter(Msg msg) {
		...
		default:
			 ...
			 * 过滤之后 第五步：传递消息
			 */
			webConnectServiceSolve.msgSubmit(msg, this);
			break;
		}
