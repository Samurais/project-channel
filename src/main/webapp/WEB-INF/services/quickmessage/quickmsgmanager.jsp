...
<div id="thispage" title="快捷短语设置<small>manager</small>">
	<!-- ==================================页面内容=================================== -->
				...
				<div class="modal-body">
					...
					<form id="defaultForm" method="post" class="form-horizontal"
						...
						<div class="form-group">
							<label class="col-lg-3 control-label">短语内容</label>
							<div class="col-lg-5">
						...
						<div class="form-group">
							<div class="col-lg-4 col-lg-offset-1">
								<button id="btn_sub" type="button"
									class="btn btn-block btn-primary">添加短语</button>
							</div>
		...
		oTableInit.Init = function() {
			$('#tb_departments').bootstrapTable({
				...
				onEditableSave : function(field, row, oldValue, $el) {
					...
					$.ajax({
						type : "post",
						url : "quickmessage_update.action",
						data : {
							'id' : row.id,
							'content' : row.content,
		...
		oInit.Init = function() {
			...
			$("#btn_delete").click(function() {
				...
				Ewin.confirm({
					...
					$.ajax({
						type : "post",
						url : "quickmessage_delete.action",
						data : {
							"ids" : ids,
						},
						success : function(data, status) {
