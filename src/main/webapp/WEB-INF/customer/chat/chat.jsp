			...
			<div class="box-body" style="height:400px">
				...
				<div id="chat_window" class="direct-chat-messages"
					...
					<div class="attachment-block clearfix">
						...
						<div class="attachment-text">
						 <a href="#">如何购买最新产品?</a></br>
						 <a href="#">如何获得最新产品信息?</a></br>
						 <a href="#">如何进行物流查询?</a></br>
						</div>
						<!-- /.attachment-text -->
						<!-- /.attachment-pushed -->
					</div>
				...
				<div class="direct-chat-contacts" title="constacts_leavingmsg"
					...
					<ul class="contacts-list">
						<li><a> <label for="leave_serviceid"
								...
								class="form-control" id="leave_serviceid" placeholder="ID"
...
<script>
	...
	$("#test1").on('click', function() {
		$.post('knowledgebase_search.action', {
			//title : "new",
			//category : "海鲜",
			//content : "这个是内容",
			queryString : "这个",
	...
	$("#test4").on('click', function() {
		$.post('knowledgebase_save.action', {
			title : "new",
			category : "海鲜",
			content : "这个是内容",
		});
