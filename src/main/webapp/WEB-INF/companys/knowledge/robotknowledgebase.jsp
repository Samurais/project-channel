...
<div id="thispage" title="机器人知识库管理<small>manager</small>">
	<!-- ==================================页面内容=================================== -->
	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#tb_departments').bootstrapTable({
				url : 'robotknowledgebase_pageQuery.action', //请求后台的URL（*）
				...
				onEditableSave : function(field, row, oldValue, $el) {
					...
					$.ajax({
						type : "post",
						url : "robotknowledgebase_update.action",
						data : {
		...
		oInit.Init = function() {
			...
			$("#btn_delete").click(function() {
				...
				Ewin.confirm({
					...
					$.ajax({
						type : "post",
						url : "robotknowledgebase_delete.action",
						data : {
							"ids" : ids,
							"companyid":getCookie("companyid")
						},
			...
			$("#btn_sub").click(function() {
				var div = $("#defaultForm");
				$.post('robotknowledgebase_save.action', {
