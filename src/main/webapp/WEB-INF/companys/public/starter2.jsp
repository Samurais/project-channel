				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview"><a href="#"> <i class="fa fa-group"></i>
						...
						<ul class="treeview-menu">
							...
							<li><a href="send_companys_role_usermanager.action"><i class="fa fa-circle-o"></i> 所有人管理</a></li>
						</ul></li>
					...
					<li class="treeview"><a href="#"> <i class="fa  fa-gear"></i>
						...
						<ul class="treeview-menu">
							...
							<li><a href="send_companys_set_systemset.action"><i class="fa fa-circle-o"></i> 系统设置</a></li>
						</ul></li>
				</ul>
				<!-- /.sidebar-menu -->
			</section>
