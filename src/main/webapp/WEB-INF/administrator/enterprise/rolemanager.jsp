...
<div id="thishead">
	...
	<!-- /bootstrap table editable-->	<link href="<%=realpath%>/resources/x-editable/bootstrap-editable.css"
		rel="stylesheet" />
	<script src="<%=realpath%>/resources/x-editable/bootstrap-editable.js"></script>
...
<div id="thispage" title="企业权限分配<small>rightmanager</small>">
...
//-- ==================================图片显示方法============================================ -->
	...
	function editRtight(id) {
		...
		$('#tb_rightedit').bootstrapTable({
			url : 'role_getRoleRight.action', //请求后台的URL（*）
	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#tb_departments').bootstrapTable({
				url : 'http://localhost/channel/data3.json', //请求后台的URL（*）
				contentType : "application/x-www-form-urlencoded; charset=UTF-8",
				method : 'post', //请求方式（*）
				toolbar : '#toolbar', //工具按钮用哪个容器
				striped : true, //是否显示行间隔色
